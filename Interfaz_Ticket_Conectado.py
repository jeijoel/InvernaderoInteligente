...
# al final del archivo tickets.py

def ventana_tickets():
    global root, entry_usuario, entry_cliente, entry_dispositivo, text_descripcion
    ...
    try:
        ...
        bg_image_tk = ImageTk.PhotoImage(
            bg_image_original_pil.filter(ImageFilter.GaussianBlur(radius=8)).convert('RGBA'))
